...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6520550784:AAHZPv8eOS2Unc91jIVYSH5PB0z8SO36lUY")
...
FORCE_SUB_CHANNEL = os.environ.get("FORCE_SUB_CHANNEL", "-1002256555387")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6765202867").split()):
        ADMINS.append(int(x))
except ValueError:
